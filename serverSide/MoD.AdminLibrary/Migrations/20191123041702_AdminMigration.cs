        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MentorUserId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Courses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Courses_AspNetUsers_MentorUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotifyReject = table.Column<bool>(nullable: false),
                    NotifyApprove = table.Column<bool>(nullable: false),
                    PaymentDone = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BalanceAmount = table.Column<float>(nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", "422f75db-75b2-4a73-bf72-2a7022feea70", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "2", "e5699462-54d7-4d27-a9a5-a6099d5dd565", "Mentor", "MENTOR" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "3", "1804d820-0a42-4f7b-a3cf-de84b7cf3b74", "Student", "STUDENT" });
